  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="container mx-auto max-w-4xl space-y-8">
        <h1 className="text-2xl sm:text-3xl font-bold tracking-light mb-6 flex items-center gap-2">
          <Link to="/" title="Back to homepage" className="hover:bg-secondary p-2 rounded-full">
            ...
            {incomingRequests.length > 0 && (
              <section className="space-y-4">
                <h2 className="text-xl font-semibold flex items-center gap-2">
                  ...
                  Friend Requests
                  <span className="badge bagde-primary ml-2">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm my-1">
                              {notification.recipient.fullName.split(" ")[0]}{" "}
