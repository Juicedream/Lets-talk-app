          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="form-control">
                ...
                <select
                  ...
                  className="select select-bordered w-full"
                >
                  <option value="">Select langauge you're learning</option>
                  {LANGUAGES.map((lang) => (
            ...
            <div className="form-control">
              ...
              <div className="relative">
                <MapPinIcon className="absolute top-1/2 transform -translate-y-1/2 left-3 size-5 tetxt-base-content opacity-70" />
                <input
                  type="text"
                  name="location"
